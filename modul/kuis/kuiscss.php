...
<head>
    ...
    <link rel="stylesheet" href="../../css/modul/kuis/kuiscss.css">
</head>
<body>
    <header id="navbar">
        <div class="back">
    ...
    <div class="footer">
        <div class="arrow_left">
            <a href="../css/elementcss.html">Previous</a>
        </div>
        <div class="arrow_right">
            <a href="../submission.php">Next</a>
    </div>
    <script src="kuiscss.js"></script>
</body>
</html>